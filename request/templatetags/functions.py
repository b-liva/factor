...
def has_perm_or_is_owner(user_obj, permissions, instance=None, colleague=None):
    ...
    if instance is not None:
        ...
        if hasattr(instance, 'customer') and not hasattr(instance, 'xpref_id'):
            ...
            if user_obj == instance.req_id.customer.user or user_obj in instance.req_id.colleagues.all():
                return True
        elif hasattr(instance, 'xpref_id') and hasattr(instance.xpref_id.req_id, 'customer'):
            if user_obj == instance.xpref_id.req_id.customer.user or \
                    user_obj in instance.xpref_id.req_id.colleagues.all() or user_obj == instance.xpref_id.req_id.owner:
                return True
